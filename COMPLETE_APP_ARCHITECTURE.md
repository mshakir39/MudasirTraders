...
- `EditInvoiceModal.tsx` (21595 lines) ⚠️ *Needs immediate splitting*
- `InvoiceGrid.tsx` (16089 lines) ⚠️ *Needs immediate splitting*

#### **Medium Components (50-150 lines):**
- `CustomerSection.tsx` (7087 lines) ⚠️ *Needs splitting*
- `ChargingServiceSection.tsx` (3746 lines) ⚠️ *Needs splitting*
- `PaymentSection.tsx` (5837 lines) ⚠️ *Needs splitting*
