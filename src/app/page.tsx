...
export default function Home() {
  ...
  const handleBrandSelection = (index: number) => {
     ...
     const slides = [
    {
      ...
      description: 'Your local battery specialist offering genuine products at competitive prices. Visit our shop at General Bus Stand for expert advice and the best deals.'
    },
    {
      id: 2,
      image: 'https://res.cloudinary.com/divdl3sad/image/upload/v1769437289/Gemini_Generated_Image_djh63edjh63edjh6_gntnqv.png',
      title: 'Premium Brands',
      subtitle: 'Osaka, AGS, Exide & More',
      description: 'Stocking only the most reliable battery brands with manufacturer warranty. All batteries tested for quality and performance before sale.'
    },
    {
      id: 3,
      image: 'https://res.cloudinary.com/divdl3sad/image/upload/v1769434960/some-electronic-parts-process-repairing-car-after-accident-man-working-with-engine-hood_pdnr2v.jpg',
      title: 'Expert Service',
      subtitle: 'Free Testing & Installation',
      description: 'Professional battery testing, installation, and maintenance services. Our experienced team ensures you get the right battery for your needs.'
    }
  ];
  ...
  return (
    <main className="min-h-screen">
      ...
      <section id="hero-section" className="relative h-screen" aria-label="Hero Section">
