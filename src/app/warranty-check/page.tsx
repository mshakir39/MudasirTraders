...
export default function WarrantyCheckPage() {
  ...
  // React 19: Optimistic updates for search history
  const [searchHistory, setSearchHistory] = useState<string[]>([]);
  const [optimisticSearches, addOptimisticSearch] = useOptimistic(
    searchHistory,
    (state, newSearch: string) => [newSearch, ...state.slice(0, 9)] // Keep last 10 searches
  );
            ...
            {optimisticSearches.length > 0 && (
              <div className='mt-4 border-t pt-4'>
                ...
                <div className='flex flex-wrap gap-2'>
                  {optimisticSearches.map((code, index) => (
                    <button
                      key={`${code}-${index}`}
            ...
            <div className='rounded-lg border border-blue-200 bg-blue-50 p-6'>
              ...
              <div className='ml-8'>
                ...
                <div className='mt-4 text-sm text-gray-600'>
                  <p>
                    <strong>Multiple Codes:</strong> You can enter multiple
                    warranty codes separated by comma or space
                  </p>
                  <p>
                    <strong>Examples:</strong> &quot;ABC123, DEF456&quot; or
                    &quot;ABC123 DEF456&quot; or &quot;1646603376
                    1291636542&quot;
                  </p>
