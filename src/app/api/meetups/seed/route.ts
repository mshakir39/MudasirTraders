...
const sampleMeetups = [
  {
    ...
    date: "2024-03-15",
    description: "Join us for our monthly customer meetup where we celebrate our loyal customers.",
  ...
  },
  {
    ...
    date: "2024-04-08",
    description: "Learn essential battery maintenance tips from Mudasir Traders' technical team.",
  ...
  },
  {
    ...
    date: "2024-05-20",
    description: "Monthly community meetup where customers can share experiences and network.",
  ...
  },
  {
    ...
    date: "2024-06-10",
    description: "Hands-on technical training for automotive battery professionals.",
  ...
  },
  {
    ...
    date: "2024-03-25",
    description: "Special day to honor our valued customers with exclusive offers.",
...
export async function POST() {
  try {
    ...
    return NextResponse.json({ error: 'Failed to seed meetups' }, { status: 500 });
  } finally {
    await client.close();
  }
}
