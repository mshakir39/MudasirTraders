...
// React 19: Enhanced Error Boundary with better error reporting
...
class BrandsErrorBoundary extends React.Component<
  ErrorBoundaryProps,
  ErrorBoundaryState
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    ...
    console.error('Brands Error Boundary caught an error:', error, errorInfo);
...
// React 19: Default error fallback with better UX
...
export default BrandsErrorBoundary;
