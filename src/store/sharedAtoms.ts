...
export const invoiceCreationStatesAtom = atom<InvoiceCreationState[]>([]);
export const activeInvoiceCreationIdAtom = atom<string | null>(null);
...
export const startNewInvoiceCreationAtom = atom(null, (get, set) => {
  set(activeInvoiceCreationIdAtom, null);
  set(showCreateInvoiceModalAtom, true);
});
