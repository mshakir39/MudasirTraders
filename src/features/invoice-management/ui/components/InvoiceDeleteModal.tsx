      ...
      <div className="space-y-4">
        ...
        <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-4">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm text-yellow-700">
            <li>
              <strong>Restore stock quantities</strong> - Add back all product quantities
            </li>
            <li>
              <strong>Preserve warranty data</strong> - Move warranties to history
            </li>
            <li>
            ...
            <li>
              <strong>Archive data</strong> - Keep audit trail in archived records
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-lg border border-red-200 bg-red-50 p-4">
          ...
          <p className="text-sm text-red-700">
            This action <strong>cannot be undone</strong>. All invoice data will be permanently removed
            (except for warranty history which is preserved for tracking purposes).
          </p>
        </div>
